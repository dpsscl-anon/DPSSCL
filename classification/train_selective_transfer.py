...
from classification.gen_data import mnist_data_print_info, cifar_data_print_info, omniglot_data_print_info, officehome_data_print_info, officehome_incremental_data_print_info, print_data_info
    ...
    for train_task_cnt, (task_for_train) in enumerate(task_training_order):
        ...
        with tf.Session(config=config) as sess:
            ...
            if save_param and _debug_mode:
                ...
                curr_param = learning_model.get_params_val(sess, use_npparams=False)
            ...
            while learning_step < min(learning_step_max, epoch_bias + patience):
                ...
                if learning_model.task_is_new and learning_step>0 and _debug_mode2:
                    print("\tPosterior : ", accumulated_posterior)
    ...
    for train_task_cnt, (task_for_train) in enumerate(task_training_order):
        ...
        with tf.Session(config=config) as sess:
            ...
            while learning_step < min(learning_step_max, epoch_bias + patience):
                ...
                #### error related process
                print('epoch %d - Train : %f, Validation : %f' % (learning_step, abs(train_error_to_compare), abs(valid_error_to_compare)))
                if learning_model.task_is_new and learning_step>0 and _debug_mode:
                    print("\tPosterior : ", accumulated_posterior)
    ...
    for train_task_cnt, (task_for_train) in enumerate(task_training_order):
        ...
        with tf.Session(config=config) as sess:
            ...
            while learning_step < min(learning_step_max, epoch_bias + patience):
                ...
                print('epoch %d - Train : %f, Validation : %f' % (learning_step, abs(train_error_to_compare), abs(valid_error_to_compare)))
                if learning_model.task_is_new and learning_step>0 and _debug_mode2:
                    print("\tSelection parameter : ", selection_variable_hist[-1])
