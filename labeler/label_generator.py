...
class LabelGenerator:
    ...
    def generate_snuba_lfs(self, log_file, sample_earlier_lfs=False, sample_earlier_lfs_prob=0.5, path_earlier_lfs=None, task_similarity_score=None, task_similarity_score_threshold=0.0, return_snuba_iter_cnt=False, unified_score=False, finetune_transferred_wls=False):
