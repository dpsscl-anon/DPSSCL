...
class HeuristicGenerator(object):
    ...
    def run_synthesizer(self, max_cardinality=1, idx=None, keep=1, model='cnn', sample_earlier_lfs=False, sample_earlier_lfs_prob=0.5, task_similarity_score=None, task_similarity_score_threshold=0.0, path_earlier_lfs=None, unified_score=False, finetune_transferred_wls=False):
        """ 
        ...
        # syn_start = time.time()
        hf, feat_combos = self.syn.generate_heuristics(model, max_cardinality, sample_earlier_lfs=sample_earlier_lfs, sample_earlier_lfs_prob=sample_earlier_lfs_prob, task_similarity_score=task_similarity_score, task_similarity_score_threshold=task_similarity_score_threshold, path_earlier_lfs=path_earlier_lfs, unified_score=unified_score, finetune_transferred_wls=finetune_transferred_wls)
